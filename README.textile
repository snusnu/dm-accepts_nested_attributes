...
http://sick.snusnu.info/2009/04/08/dm-accepts_nested_attributes/ where I will try to comment on the
...
- should allow to create a new project via Person#projects_attributes (FAILED - 1)
...
- should allow to create a new project via Person#projects_attributes (FAILED - 3)
- should allow to update an existing project via Person#projects_attributes (FAILED - 4)
- should allow to delete an existing project via Person#projects_attributes (FAILED - 5)
</code>
</pre>
