...
Inside @lib/dm-accepts_nested_attributes/autosave_association.rb@ the @#save@ method has quite some
debugging statements (and helper methods). Feel free to (un)comment as you wish, and help me find
the remaining issues, so that we can finally enjoy nested model assignment in datamapper as well!
...
- should allow to update an existing person via Profile#person_attributes (FAILED - 1)
...
- should allow to create a new person via Profile#person_attributes
- should allow to update an existing person via Profile#person_attributes (FAILED - 2)
...
- should allow to update an existing task via Project#tasks_attributes (FAILED - 3)
...
- should allow to create a new task via Project#tasks_attributes
- should allow to update an existing task via Project#tasks_attributes (FAILED - 4)
...
- should allow to create a new project via Person#projects_attributes (FAILED - 5)
- should allow to update an existing project via Person#projects_attributes (FAILED - 6)
...
- should allow to create a new project via Person#projects_attributes (FAILED - 7)
- should allow to update an existing project via Person#projects_attributes (FAILED - 8)
- should allow to delete an existing project via Person#projects_attributes (FAILED - 9)
</code>
</pre>
